...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <script type="text/javascript" src="static/js/technology.js"></script>
    </head>
    <body>
    	...
    	<div id="content">
    		<ul class="leftNav">
    	        ...
    	        <p>Therefore, we invest a lot of time and energy in our development infrastructure.  For example, our web development <a href="technology/catamaran/tutorial">tutorial</a> and <a href="technology/catamaran/source">tools</a> ensure a consistent coding style and facilitates team member load balancing and on-boarding.</p>  
    	        <p>And our constantly-evolving <a href="technology/knowledge">Knowledge Base</a> ensures we never have to solve the same engineering problem twice.  Think of it as a combination of a wiki and Stack Overflow backed by a powerful search engine -- click the tag cloud below for a test drive.</p>
