    	...
    	<div id="outerContent">
	        ...
	        <div id="content">     
				...
				<ul class="leftNav">
					...
					<li><a class='current' href="clients-travelclick">TravelClick</a></li>
				</ul><div id="mainCol">
					
					<img style="float:right; margin-bottom: 8px;" src="http://www.travelclick.com/sites/all/themes/travelclick/logo.png" />
