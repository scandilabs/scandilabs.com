    	...
    	<div id="outerContent">
	        ...
	        <div id="content">     
				...
				<ul class="leftNav">
					...
					<li><a class='current' href="clients-medventive">MedVentive</a></li>
					...
					<img style="float:right; margin-bottom: 8px;" src="http://www.medventive.com/Collateral/Templates/English-US/Images/top_logo.gif" />
					
                    <h2 class="noTopMargin">Advanced Application Monitoring</h2>
					<p> 
