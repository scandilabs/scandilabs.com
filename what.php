	                	...
	                	<tr class="firstRow">
							...
							<td class="processCol">
			                    <ul>
			                        ...
			                        <li>Slow progress</li>
			                        <li>Engineering team anarchy</li>
			                    </ul>
		                    </td>
	                   </tr>
	                   <tr class="secondRow">
		                   ...
		                   <td class="processCol">
			                    <ul>
			                        ...
			                        <li>Improved product / engineering communication</li>
			                    </ul>
		                    </td>                	
						</tr>
					</table>
	        ...
	        -->
	        	...
	        	<div id="barBox">
	        	    <div id="barLeft">
	        	        <h2>Startups</h2>
	        	        <ul>
	        	            <li id="bar1"><a href="consumer-web"><div>Consumer Web and Mobile</div></a></li>
	        	            <li id="bar2"><a href="enterprise"><div>Corporate Business Systems</div></a></li>
	        	            <li id="bar3"><a href="it-consulting"><div>Enterprise IT Consulting</div></a></li>
